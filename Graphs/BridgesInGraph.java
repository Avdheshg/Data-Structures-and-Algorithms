...
/*
    Bridge: When V remove and edge then the number of connected components increases
    This is similar to articulation point problem
    V will be having connected and undirected graph 
    Back edges will never be bridges so V don't consider them
    ...
    parent[]: while going through adjacency list V need to check that this adjacent is parent or not 

    An edge u-v is called an bridge if low[v] > disc[u]
